...
//$endpoint = "http://slivingston02.lampt.eeecs.qub.ac.uk/cain/api/playwithapi3.php?allfields";
$endpoint = "http://slivingston02.lampt.eeecs.qub.ac.uk/cain/api/playwithapi3.php";
...
<?php 
//include('theme/footerscripts.php'); 
?>
